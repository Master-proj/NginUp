    ...
    <div x-show="view === 'report'" x-transition.opacity.duration.300ms>
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-end gap-4 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500">Last 30 days summary</p>
            </div>
            <div class="flex items-center gap-2">
                <button class="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-bold rounded-full shadow-sm flex items-center gap-2 hover:bg-gray-50 transition-colors">
                    <i class="fa-regular fa-calendar"></i> Last 30 Days <i class="fa-solid fa-chevron-down text-[10px]"></i>
                </button>
            ...
            <div class="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <div class="flex items-baseline gap-2 mb-6">
                        <span class="text-3xl font-extrabold text-gray-900">$14,280.50</span>
                        <span class="text-xs font-bold text-brand-orange"><i class="fa-solid fa-arrow-trend-up"></i> 18%</span>
                    </div>
                </div>
                ...
                <div class="bg-blue-50/50 border border-blue-50 rounded-xl p-4 flex justify-between items-center">
                    <div>
                        ...
                        <div class="text-sm font-bold text-gray-900">$3,150.00</div>
                    </div>
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm">
                    ...
                    <div class="flex justify-between items-end mb-6 text-center">
                        <div>
                            <div class="text-xl font-extrabold text-gray-900">40</div>
                            <div class="text-[10px] font-bold text-gray-400">STAYS</div>
                        </div>
                        <div class="w-px h-8 bg-gray-200"></div>
                        <div>
                            <div class="text-xl font-extrabold text-blue-500">12</div>
                            <div class="text-[10px] font-bold text-gray-400">NIGHTS</div>
                        </div>
                        <div class="w-px h-8 bg-gray-200"></div>
                        <div>
                            <div class="text-xl font-extrabold text-red-500">3</div>
                    ...
                    <div class="w-full h-1.5 bg-gray-100 rounded-full flex overflow-hidden">
                        <div class="h-full bg-brand-orange" style="width: 70%"></div>
                ...
                <div class="bg-[#1c333a] rounded-[24px] p-6 shadow-md flex justify-between items-center text-white">
                    <div>
                        ...
                        <div class="text-2xl font-extrabold mb-1">$11,852.00</div>
                        <div class="text-[10px] text-white/60">After platform fees & taxes</div>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div class="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex items-center gap-3 text-[10px] font-bold text-gray-400">
                        <div class="flex items-center gap-1"><span class="w-2 h-2 rounded-sm bg-brand-orange"></span> This Mo</div>
                        <div class="flex items-center gap-1"><span class="w-2 h-2 rounded-sm bg-blue-100"></span> Last</div>
                    </div>
                </div>
            ...
            <div class="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm flex flex-col justify-between">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-[9px] text-gray-500">12% of reservation total</div>
                                </div>
                            </div>
                            <div class="text-sm font-bold text-gray-900">-$1,411.58</div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="text-xs font-bold text-gray-900">Taxes</div>
                                    <div class="text-[9px] text-gray-500">Local and state taxes</div>
                                </div>
                            </div>
                            <div class="text-sm font-bold text-gray-900">-$286.92</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-100 flex justify-between items-center bg-blue-50/50 -mx-6 px-6 -mb-6 pb-6 rounded-b-[24px]">
                    ...
                    <span class="text-sm font-extrabold text-brand-orange">-$2,428.50</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm mb-4">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between group">
                    <div class="flex items-center gap-3">
                        <img src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=100&auto=format&fit=crop" class="w-10 h-10 rounded-xl object-cover">
                        <div>
                            <div class="text-xs font-bold text-gray-900 group-hover:text-brand-orange transition-colors">Ocean View Penthouse</div>
                            <div class="text-[9px] text-gray-400">Oct 24 • #TXN-89231</div>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm font-bold text-gray-900 mb-0.5">$1,450.00</div>
                        <span class="px-2 py-0.5 bg-green-100 text-green-700 text-[8px] font-bold rounded-full">SUCCESS</span>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between group">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="text-xs font-bold text-gray-900 group-hover:text-brand-orange transition-colors">Modern Studio Market</div>
                            <div class="text-[9px] text-gray-400">Oct 22 • #TXN-89104</div>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm font-bold text-gray-900 mb-0.5">$850.00</div>
                        <span class="px-2 py-0.5 bg-green-100 text-green-700 text-[8px] font-bold rounded-full">SUCCESS</span>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between group">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="text-xs font-bold text-gray-900 group-hover:text-brand-orange transition-colors">Weekly Payout</div>
                            <div class="text-[9px] text-gray-400">Oct 20 • Bank ****1234</div>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm font-bold text-brand-orange mb-0.5">-$4,200.00</div>
                        <span class="px-2 py-0.5 bg-blue-100 text-blue-600 text-[8px] font-bold rounded-full">SENT</span>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-[24px] p-5 shadow-sm mb-4 space-y-4">
            ...
            <div class="flex items-center gap-2 overflow-x-auto hide-scrollbar pb-1">
                ...
                <button class="px-5 py-2 bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 text-xs font-bold rounded-full flex items-center gap-2 transition-colors ml-auto whitespace-nowrap">
                    <i class="fa-regular fa-calendar"></i> Last 90 Days <i class="fa-solid fa-chevron-down text-[10px]"></i>
                </button>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white border border-gray-100 rounded-[24px] p-5 shadow-sm flex items-center justify-between cursor-pointer hover:border-brand-orange/30 transition-colors group">
                <div class="flex gap-4 items-center">
                    <img src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=100&auto=format&fit=crop" class="w-14 h-14 rounded-xl object-cover">
                    <div class="flex flex-col gap-1">
                        <h4 class="text-sm font-bold text-gray-900 group-hover:text-brand-orange transition-colors">Urban Glass Loft</h4>
                        <div class="flex items-center gap-2 text-[10px] text-gray-500 font-medium">
                            <span class="text-brand-orange font-bold">#TXN-89231</span>
                            <span>•</span>
                ...
                <div class="flex flex-col items-end gap-1">
                    <span class="text-base font-extrabold text-brand-orange">+$1,450.00</span>
            ...
            <div class="bg-white border border-gray-100 rounded-[24px] p-5 shadow-sm flex items-center justify-between cursor-pointer hover:border-brand-orange/30 transition-colors group">
                <div class="flex gap-4 items-center">
                    <div class="w-14 h-14 rounded-xl bg-blue-100 text-blue-500 flex items-center justify-center text-xl">
                        <i class="fa-solid fa-building-columns"></i>
                    </div>
                    <div class="flex flex-col gap-1">
                        <h4 class="text-sm font-bold text-gray-900 group-hover:text-brand-orange transition-colors">Payout to Bank Account</h4>
                        <div class="flex items-center gap-2 text-[10px] text-gray-500 font-medium">
                            <span class="text-blue-500 font-bold">#TXN-89104</span>
                            <span>•</span>
                ...
                <div class="flex flex-col items-end gap-1">
                    <span class="text-base font-extrabold text-gray-900">-$2,428.50</span>
                    <i class="fa-solid fa-chevron-right text-gray-300 text-xs mt-2 group-hover:text-brand-orange transition-colors"></i>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-100 rounded-[24px] p-5 shadow-sm flex items-center justify-between cursor-pointer hover:border-brand-orange/30 transition-colors group">
                <div class="flex gap-4 items-center">
                    <img src="https://images.unsplash.com/photo-1507089947368-19c1da9775ae?q=80&w=100&auto=format&fit=crop" class="w-14 h-14 rounded-xl object-cover">
                    <div class="flex flex-col gap-1">
                        <h4 class="text-sm font-bold text-gray-900 group-hover:text-brand-orange transition-colors">Sunset Villa Poolside</h4>
                        <div class="flex items-center gap-2 text-[10px] text-gray-500 font-medium">
                            <span class="text-brand-orange font-bold">#TXN-89002</span>
                            <span>•</span>
                ...
                <div class="flex flex-col items-end gap-1">
                    <span class="text-base font-extrabold text-brand-orange">+$850.00</span>
                    <i class="fa-solid fa-chevron-right text-gray-300 text-xs mt-2 group-hover:text-brand-orange transition-colors"></i>
                </div>
            </div>
